        ...
        <div class="col-md-6">
            <form action="{{ route('umkm.index') }}" method="GET">
                <div class="input-group">
                    <input type="text" class="form-control" name="search" placeholder="Cari UMKM..."
        ...
        <div class="col-md-6">
            <div class="d-flex justify-content-end">
                <form action="{{ route('umkm.index') }}" method="GET" id="kategoriForm">
                    <select class="form-select w-auto" name="kategori"
                        onchange="document.getElementById('kategoriForm').submit()">
                        <option value="">Semua Kategori</option>
                        <option value="Makanan & Minuman"
                            {{ request('kategori') == 'Makanan & Minuman' ? 'selected' : '' }}>Makanan & Minuman</option>
                        <option value="Kerajinan Tangan" {{ request('kategori') == 'Kerajinan Tangan' ? 'selected' : '' }}>
                            Kerajinan Tangan</option>
                        <option value="Pertanian" {{ request('kategori') == 'Pertanian' ? 'selected' : '' }}>Pertanian
                        </option>
                ...
                <div class="col-md-6 col-lg-3 mb-4">
                    <div class="card card-umkm h-100">
                        @if ($umkm->media->count() > 0)
                            <img src="{{ asset('storage/' . $umkm->media->first()->file_url) }}" class="card-img-top"
                                alt="{{ $umkm->nama_usaha }}" style="height: 200px; object-fit: cover;">
                        @else
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                <a href="{{ route('umkm.show', $umkm->umkm_id) }}"
        ...
        <div class="col-12">
            <div class="card bg-light">
                <div class="card-body text-center">
                    ...
                    <p class="mb-0">Dengan membeli produk UMKM, Anda turut membangun ekonomi desa dan menciptakan lapangan
                        kerja</p>
                </div>
            </div>
        </div>
