        ...
        <form action="{{ route('binadesa.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    @if($warga->isEmpty())
                        <div class="text-danger mt-2">
                            <small>Tidak ada data warga tersedia.
                                <a href="{{ route('warga.create') }}" class="text-danger">Tambahkan data warga terlebih dahulu</a>
                            </small>
                        </div>
                    @endif
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="kategori" class="form-control" required>
                        ...
                        <option value="Industri Kecil" {{ old('kategori') == 'Industri Kecil' ? 'selected' : '' }}>Industri Kecil</option>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="kontak" class="form-control" value="{{ old('kontak') }}" placeholder="Nomor HP/WhatsApp" required>
                </div>
                <div class="col-md-6 mb-3">
