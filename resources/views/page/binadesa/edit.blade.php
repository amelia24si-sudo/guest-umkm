    ...
    <div class="container-fluid">
        <div class="card border-0 shadow-lg">
            ...
            <div class="card-header bg-white border-bottom py-4">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div>
                        ...
                        <h4 class="card-title mb-0 fw-bold">
                            <i class="fa fa-edit me-2 text-warning"></i>Edit UMKM/Binadesa
                        </h4>
                    </div>
                ...
                <p class="text-muted mb-0 mt-1">Perbarui data UMKM/Binadesa di bawah ini</p>
            </div>
                ...
                <form action="{{ route('binadesa.update', $binadesa) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nama_usaha" class="form-control"
                                    value="{{ old('nama_usaha', $binadesa->nama_usaha) }}"
                                ...
                                <select name="pemilik_warga_id" class="form-select" id="inputselect" required>
                                    ...
                                    @foreach ($warga as $w)
                                        <option value="{{ $w->warga_id }}" data-alamat="{{ $w->alamat }}"
                                            ...
                                            data-telp="{{ $w->telp }}"
                                            {{ old('pemilik_warga_id', $binadesa->pemilik_warga_id) == $w->warga_id ? 'selected' : '' }}>
                                            {{ $w->nama }} - {{ $w->no_ktp }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="alamat" class="form-control" rows="3" required placeholder="Masukkan alamat lengkap usaha"
                                    id="alamat">{{ old('alamat', $binadesa->alamat) }}</textarea>
                                <small class="form-text text-muted">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="rt" class="form-control"
                                    value="{{ old('rt', $binadesa->rt) }}" placeholder="RT" id="rt" required>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="rw" class="form-control"
                                    value="{{ old('rw', $binadesa->rw) }}" placeholder="RW" id="rw" required>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="kategori" class="form-select" required>
                                    ...
                                    <option value="Makanan & Minuman"
                                        {{ old('kategori', $binadesa->kategori) == 'Makanan & Minuman' ? 'selected' : '' }}>
                                        Makanan & Minuman
                                    </option>
                                    ...
                                    <option value="Pertanian"
                                        {{ old('kategori', $binadesa->kategori) == 'Pertanian' ? 'selected' : '' }}>
                                        Pertanian
                                    </option>
                                    <option value="Peternakan"
                                        {{ old('kategori', $binadesa->kategori) == 'Peternakan' ? 'selected' : '' }}>
                                        Peternakan
                                    </option>
                                    <option value="Jasa"
                                        {{ old('kategori', $binadesa->kategori) == 'Jasa' ? 'selected' : '' }}>
                                        Jasa
                                    </option>
                                    <option value="Perdagangan"
                                        {{ old('kategori', $binadesa->kategori) == 'Perdagangan' ? 'selected' : '' }}>
                                        Perdagangan
                                    </option>
                                    <option value="Industri Kecil"
                                        {{ old('kategori', $binadesa->kategori) == 'Industri Kecil' ? 'selected' : '' }}>
                                        Industri Kecil
                                    </option>
                                    <option value="Lainnya"
                                        {{ old('kategori', $binadesa->kategori) == 'Lainnya' ? 'selected' : '' }}>
                                        Lainnya
                                    </option>
                                </select>
                                <small class="form-text text-muted">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="kontak" class="form-control"
                                    value="{{ old('kontak', $binadesa->kontak) }}" placeholder="Nomor HP/WhatsApp"
                                    required id="telp">
                                <small class="form-text text-muted">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="deskripsi" class="form-control" rows="4" placeholder="Deskripsikan usaha secara detail...">{{ old('deskripsi', $binadesa->deskripsi) }}</textarea>
                            <small class="form-text text-muted">
                                <i class="fa fa-tips me-1"></i>
