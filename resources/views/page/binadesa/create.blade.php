    ...
    <section class="bg-light rounded p-4">
        ...
        <form action="{{ route('binadesa.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <section class="mb-3">
                ...
                <textarea name="alamat" id= "alamat" class="form-control" rows="3" required placeholder="Alamat">{{ old('alamat') }}</textarea>
            </section>
                ...
                <section class="col-md-6 mb-3">
                    ...
                    <select name="kategori" class="form-control" required>
                        ...
                        <option value="Makanan & Minuman"
                            {{ old('kategori') == 'Makanan & Minuman' ? 'selected' : '' }}>Makanan
                            & Minuman</option>
                        ...
                        <option value="Peternakan" {{ old('kategori') == 'Peternakan' ? 'selected' : '' }}>Peternakan
                        </option>
            ...
            <section class="mb-3">
                ...
                <textarea name="deskripsi" class="form-control" rows="4" placeholder="Deskripsi">{{ old('deskripsi') }}</textarea>
            </section>
