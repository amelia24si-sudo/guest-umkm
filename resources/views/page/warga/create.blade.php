    ...
    <div class="container-fluid">
        <div class="card border-0 shadow-lg">
            ...
            <div class="card-header bg-white border-bottom py-4">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div>
                        ...
                        <h4 class="mb-0 fw-bold">
                            <i class="fa fa-user-plus me-2 text-primary"></i>Tambah Data Warga Baru
                        </h4>
                    </div>
                ...
                <p class="text-muted mb-0 mt-2">Lengkapi form di bawah untuk menambahkan data warga baru</p>
            </div>
                ...
                <form action="{{ route('warga.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="no_ktp" class="form-control" value="{{ old('no_ktp') }}"
                                    placeholder="Masukkan 16 digit NIK" required maxlength="16" pattern="[0-9]{16}"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label class="form-label fw-semibold">
                                    <i class="fa fa-venus-mars me-1"></i>Jenis Kelamin <span
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="telp" class="form-control"
                                    value="{{ old('telp') }}" placeholder="Masukkan nomor telepon" required
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="alamat" class="form-control" rows="3" placeholder="Masukkan alamat lengkap" required>{{ old('alamat') }}</textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="rt" class="form-control"
                                    value="{{ old('rt') }}" placeholder="Masukkan nomor RT" required
                                    pattern="[0-9]+" title="Hanya angka yang diperbolehkan">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="rw" class="form-control"
                                    value="{{ old('rw') }}" placeholder="Masukkan nomor RW" required
                                    pattern="[0-9]+" title="Hanya angka yang diperbolehkan">
                            </div>
                        </div>
                    </div>
